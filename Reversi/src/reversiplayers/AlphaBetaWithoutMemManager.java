...
public class AlphaBetaWithoutMemManager implements ReversiPlayer{
	private int color = 0;
	private int other = 0;
	
	private long maxTime = 0;
	private long tbuffer = 300;
	private long t0 = 0;
	private long tR = 0;
	...
	public void initialize(int color, long timeout){
		...
		if (color == GameBoard.RED)
			System.out.println("AlphaBetaWithoutMem ist Spieler RED.");
		else if (color == GameBoard.GREEN)
			System.out.println("AlphaBetaWithoutMem ist Spieler GREEN.");
		PC = new PointCalc();
	}
